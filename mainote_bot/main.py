...
from mainote_bot.bot.commands import start_command, help_command, reset_command, integrations_command, show_notes_command
...
async def initialize_bot():
    ...
    try:
        ...
        application.add_handler(CommandHandler("integrations", integrations_command))
        application.add_handler(CommandHandler("show_notes", show_notes_command))
